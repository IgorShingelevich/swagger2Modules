package io.swagger.client.service.adobeService;
...
import io.swagger.client.service.adobeService.auth.HttpBasicAuth;
import io.swagger.client.service.adobeService.auth.ApiKeyAuth;
import io.swagger.client.service.adobeService.auth.OAuth;
import io.swagger.client.service.adobeService.auth.OAuth.AccessTokenListener;
import io.swagger.client.service.adobeService.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://api.apis.guru/";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
