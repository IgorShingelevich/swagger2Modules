package io.swagger.client.service.petStoreService;
...
import io.swagger.client.service.petStoreService.auth.HttpBasicAuth;
import io.swagger.client.service.petStoreService.auth.ApiKeyAuth;
import io.swagger.client.service.petStoreService.auth.OAuth;
import io.swagger.client.service.petStoreService.auth.OAuth.AccessTokenListener;
import io.swagger.client.service.petStoreService.auth.OAuthFlow;
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("api_key".equals(authName)) {
        ...
        auth = new OAuth(OAuthFlow.implicit, "https://petstore.swagger.io/oauth/authorize", "", "read:pets, write:pets");
      } else {
